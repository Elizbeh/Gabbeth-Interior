...
const stripePromise = loadStripe("pk_test_51Mb3reGPxelQbZD2CEA5u7JP63hGG6bY8sckbcXajRwQAHPSKly2AnOY1wpmaxa4Zw9fuyzoNNFTKdTXLYOATpqH00kkuV8c1p");

function CartPage() {
    const user = useSelector((state) => state.user);
    const products = useSelector((state) => state.products);
    const userCartObj = user.cart;
    let cart = products.filter((product) => userCartObj[product._id] != null);//show cart object
